...
class deepforest(pl.LightningModule):
    ...
    def predict_step(self, batch, batch_idx):
        ...
        payload: dict[str, object] = {
            ...
            "pl_device": str(getattr(self, "device", "unknown")),
            "cuda_available": bool(torch.cuda.is_available()),
        }

        # Add trainer accelerator info when available
        try:
            payload["trainer_accelerator"] = type(self.trainer.accelerator).__name__
        except Exception:
            payload["trainer_accelerator"] = "unknown"
